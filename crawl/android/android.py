...
class Android:
    ...
    def run(self):
        ...
        rss.run()
        print("end androidweekly ... ...")
        print("start Android-Arsenal ... ...")
        rss = RssChannel(self.conn, "https://android-arsenal.com/rss", "Android", "Android", "Android-Arsenal", config.priority_high)
        rss.run()
        print("end Android-Arsenal ... ...")
        print("start AndroidHive ... ...")
        rss = RssChannel(self.conn, "http://www.androidhive.info/feed/", "Android", "Android", "AndroidHive", config.priority_high)
        rss.run()
        print("end AndroidHive ... ...")
        print("start StylingAndroid ... ...")
        rss = RssChannel(self.conn, "http://feeds.feedburner.com/StylingAndroid", "Android", "Android", "StylingAndroid", config.priority_high)
        rss.run()
        print("end StylingAndroid ... ...")
